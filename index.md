...
The resistor value was chosen based on testing with the pressure sensors. Arduino code `[Arduino] Sensor Values/Project__sensing.ino` was then implemented to collect pressure sensor and IMU data.
